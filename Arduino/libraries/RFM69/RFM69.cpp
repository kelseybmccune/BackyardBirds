...
bool RFM69::initialize(uint8_t freqBand, uint8_t nodeID, uint8_t networkID)
{
  ...
  _slaveSelectPin = 8;
//  Serial.print("slave select pin: "); serial.println(_slaveSelectPin);
  _interruptNum = 9;
//  Serial.print("interrupt number: "); serial.println(_interruptNum);
  _interruptPin = 9;
//  Serial.print("interrupt pin: "); serial.println(_interruptPin);
